...
namespace Dominio
{
    public class Vivienda : Apartamento
    {
        ...
        #region Constructor
        public Vivienda(int piso, int numero, int metrajeTotal, decimal precioBaseXm2, string orientacion, int cantDormitorios, int cantidadBanio, bool garage) 
        ...
        public override decimal calcularPrecio()
        {
            ...
            {
                precioTotal += (15 * precioTotal) / 100;
            }
